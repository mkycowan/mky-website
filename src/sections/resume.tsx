    ...
    <section className="my-8 pt-8 border-b-0 border-zinc-800 rounded-lg backdrop-blur-lg bg-zinc-800/50 overflow-hidden">
      <div className="grid grid-cols-2 gap-8">
        <div className="relative order-last md:order-first col-span-full md:col-span-1 h-60">
          ...
          <div className="absolute top-4 -bottom-8 right-8 w-3/4 md:w-7/12 bg-zinc-100 rounded-xl rounded-b-none drop-shadow-md -rotate-2 p-6 text-zinc-800">
            Resume???
          </div>
        </div>
        <div className="col-span-full md:col-span-1 flex flex-col justify-center">
          ...
          <div className="my-4">
            ...
            <a className="shrink inline-block w-auto mt-4 py-2 px-3 bg-zinc-200 hover:bg-zinc-300 text-zinc-700 text-sm cursor-pointer rounded-md">
              Download Resume
            </a>
          </div>
        </div>
